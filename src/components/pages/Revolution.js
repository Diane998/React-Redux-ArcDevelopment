...
const Revolution = () => {
  ...
  const sections = [
    {
      col1: {
        ...
        imgStyles: {
          maxWidth: matchesSM ? '80vw' : '40em',
          marginRight: matchesMD ? 0 : '5em',
          marginBottom: matchesMD ? '2em' : 0
        },
        justifyImgContainer: matchesMD ? 'center' : undefined
      },
      col2: {
        title: 'Vision',
        paragraphs: [
        ...
        typographyStyle: matchesMD ? 'center' : 'right'
      },
      rowStyles: { margin: '2.5em 0' },
      rowDirection: matchesMD ? 'column' : 'row'
    },
    {
      col1: {
        lottieContainerStyles: matchesMD ? 'center' : 'flex-end',
        options: defaultOptions,
        lottieStyle: { maxWidth: '40em', margin: 0 }
      },
      col2: {
        title: 'Technology',
        paragraphs: [
        ...
        typographyStyle: matchesMD ? 'center' : undefined
      },
      rowStyles: { margin: '2.5em 0' }
    },
    {
      ...
      col2: {
        ...
        paragraphStyles: { color: '#fff' }
      },
      rowStyles: {
        margin: '2.5em 0',
        backgroundColor: '#B3B3B3',
        padding: matchesSM ? '2em' : '8em'
      },
      rowDirection: matchesMD ? 'column' : 'row'
    },
    {
      col1: {
        ...
        justifyImgContainer: matchesMD ? 'center' : 'flex-end'
      },
      col2: {
        title: 'Mockup',
        paragraphs: [
      ...
      rowStyles: { margin: '2.5em 0' },
      rowDirection: matchesMD ? 'column' : 'row-reverse'
    },
    {
      col1: {
        src: review,
    ...
    },
    {
      ...
      rowStyles: { padding: '2.5em', background: '#39B54A' },
      rowDirection: matchesMD ? 'column' : 'row-reverse'
    },
    {
      col1: {
  ...
  return (
    <Grid container direction="column">
      ...
      {sections.map(({ col1, col2, rowStyles, rowDirection }, i) => (
        <React.Fragment key={i}>
          {col1.lottieStyle ? (
            ...
            <Grid
              ...
              style={rowStyles}
            >
              <Grid item container justify={col1.justifyImgContainer} lg>
                <img
                  src={col1.src}
                  alt={col1.alt}
                  style={col1.imgStyles}
